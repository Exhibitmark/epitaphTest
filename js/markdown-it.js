    ...
    return function e(r, t, n) {
        ...
        18: [function (e, r, t) {
            ...
            r.exports = function (e, r, t, s) {
                ...
                for (m = [e.bsCount[r]], e.bsCount[r] = e.sCount[r] + 1 + (v ? 1 : 0), u = D >= E, k = [e.sCount[r]], e.sCount[r] = f - c, b = [e.tShift[r]], e.tShift[r] = D - e.bMarks[r], C = e.md.block.ruler.getRules("blockquote"), g = e.parentType, e.parentType = "blockquote", A = !1, h = r + 1; h < t && (e.sCount[h] < e.blkIndent && (A = !0), !((D = e.bMarks[h] + e.tShift[h]) >= (E = e.eMarks[h]))); h++)
        ...
        25: [function (e, r, t) {
            ...
            r.exports = function (e, r, t, n) {
                var i, a, c, l, u, p, h, f, d, m, _, g, k, b, v, y, C, x, A, w, D, E, q, F, S, L, z, T, I = !1,
                    R = !0;
                if (e.sCount[r] - e.blkIndent >= 4) return !1;
                ...
                for (_ = e.tokens.length, h ? (T = e.push("ordered_list_open", "ol", 1), 1 !== k && (T.attrs = [
                        ["start", k]
                    ])) : T = e.push("bullet_list_open", "ul", 1), T.map = m = [r, 0], T.markup = String.fromCharCode(g), v = r, F = !1, z = e.md.block.ruler.getRules("list"), x = e.parentType, e.parentType = "list"; v < t;) {
        ...
        27: [function (e, r, t) {
            ...
            r.exports = function (e, r, t, o) {
                var i, a, c, l, u, p, h, f, d, m, _, g, k, b, v, y, C = 0,
                            ...
                            for (m = 0, r = (i = y[t].children).length - 1; r >= 0; r--)
                                if ("link_close" !== (c = i[r]).type) {
                                    if ("html_inline" === c.type && (v = c.content, /^<a[>\s]/i.test(v) && m > 0 && m--, s(c.content) && m++), !(m > 0) && "text" === c.type && e.md.linkify.test(c.content)) {
                                        for (p = c.content, b = e.md.linkify.match(p), l = [], d = c.level, f = 0, u = 0; u < b.length; u++) _ = b[u].url, g = e.md.normalizeLink(_), e.md.validateLink(g) && (k = b[u].text, k = b[u].schema ? "mailto:" !== b[u].schema || /^mailto:/i.test(k) ? e.md.normalizeLinkText(k) : e.md.normalizeLinkText("mailto:" + k).replace(/^mailto:/, "") : e.md.normalizeLinkText("http://" + k).replace(/^http:\/\//, ""), (h = b[u].index) > f && ((a = new e.Token("text", "", 0)).content = p.slice(f, h), a.level = d, l.push(a)), (a = new e.Token("link_open", "a", 1)).attrs = [
                                            ["href", g]
                                        ], a.level = d++, a.markup = "linkify", a.info = "auto", l.push(a), (a = new e.Token("text", "", 0)).content = k, a.level = d, l.push(a), (a = new e.Token("link_close", "a", -1)).level = --d, a.markup = "linkify", a.info = "auto", l.push(a), f = b[u].lastIndex);
        ...
        34: [function (e, r, t) {
            ...
            r.exports = function (e) {
                ...
                if (e.md.options.typographer)
                    for (r = e.tokens.length - 1; r >= 0; r--) "inline" === e.tokens[r].type && (s.test(e.tokens[r].content) && c(e.tokens[r].children), n.test(e.tokens[r].content) && l(e.tokens[r].children))
            }
        }, {}],
        35: [function (e, r, t) {
            "use strict";
                ...
                for (D = [], t = 0; t < e.length; t++) {
                    ...
                    if (D.length = A + 1, "text" === i.type) {
                        ...
                        e: for (; h < f && (a.lastIndex = h, p = a.exec(u));) {
                            if (C = x = !0, h = p.index + 1, w = "'" === p[0], _ = 32, p.index - 1 >= 0) _ = u.charCodeAt(p.index - 1);
                            else
        ...
        37: [function (e, r, t) {
            ...
            r.exports = function (e, r) {
                ...
                return 60 === e.src.charCodeAt(u) && (!((t = e.src.slice(u)).indexOf(">") < 0) && (s.test(t) ? (a = (o = t.match(s))[0].slice(1, -1), c = e.md.normalizeLink(a), !!e.md.validateLink(c) && (r || ((l = e.push("link_open", "a", 1)).attrs = [
                    ["href", c]
                ], l.markup = "autolink", l.info = "auto", (l = e.push("text", "", 0)).content = e.md.normalizeLinkText(a), (l = e.push("link_close", "a", -1)).markup = "autolink", l.info = "auto"), e.pos += o[0].length, !0)) : !!n.test(t) && (a = (i = t.match(n))[0].slice(1, -1), c = e.md.normalizeLink("mailto:" + a), !!e.md.validateLink(c) && (r || ((l = e.push("link_open", "a", 1)).attrs = [
                    ["href", c]
            ...
            function n(e, r) {
                ...
                for (t = 0; t < p; t++)
                    if ((s = r[t]).length = s.length || 0, s.close) {
                        for (u.hasOwnProperty(s.marker) || (u[s.marker] = [-1, -1, -1]), i = u[s.marker][s.length % 3], a = -1, n = t - s.jump - 1; n > i; n -= o.jump + 1)
                            if ((o = r[n]).marker === s.marker && (-1 === a && (a = n), o.open && o.end < 0 && o.level === s.level && (c = !1, (o.close || s.open) && (o.length + s.length) % 3 == 0 && (o.length % 3 == 0 && s.length % 3 == 0 || (c = !0)), !c))) {
            ...
            r.exports = function (e, r) {
                ...
                if ((u = c + 1) < b && 40 === e.src.charCodeAt(u)) {
                    ...
                    if (h = e.md.helpers.parseLinkTitle(e.src, u, e.posMax), u < b && _ !== u && h.ok)
                        for (f = h.str, u = h.pos; u < b && (o = e.src.charCodeAt(u), s(o) || 10 === o); u++);
                    else f = "";
                ...
                return r || (i = e.src.slice(l, c), e.md.inline.parse(i, e.md, e.env, m = []), (d = e.push("image", "img", 0)).attrs = t = [
                    ["src", g],
                    ["alt", ""]
                ], d.children = m, d.content = i, f && t.push(["title", f])), e.pos = u, e.posMax = b, !0
            }
        }, {
            "../common/utils": 4
        }],
        ...
        47: [function (e, r, t) {
            ...
            a.prototype.pushPending = function () {
                ...
                var s = new n(e, r, t),
                    o = null;
                return t < 0 && (this.level--, this.delimiters = this._prev_delimiters.pop()), s.level = this.level, t > 0 && (this.level++, this._prev_delimiters.push(this.delimiters), this.delimiters = [], o = {
                    delimiters: this.delimiters
                }), this.pendingLevel = this.level, this.tokens.push(s), this.tokens_meta.push(o), s
            }, a.prototype.scanDelims = function (e, r) {
                var t, n, a, c, l, u, p, h, f, d = e,
                    m = !0,
                    _ = !0,
                    g = this.posMax,
        ...
        53: [function (e, r, t) {
            ...
            function p(r) {
                ...
                r.re.schema_test = RegExp("(^|(?!_)(?:[><\uff5c]|" + t.src_ZPCc + "))(" + p + ")", "i"), r.re.schema_search = RegExp("(^|(?!_)(?:[><\uff5c]|" + t.src_ZPCc + "))(" + p + ")", "ig"), r.re.pretest = RegExp("(" + r.re.schema_test.source + ")|(" + r.re.host_fuzzy_test.source + ")|@", "i"),
                    function (e) {
            ...
            }, d.prototype.onCompile = function () {}, r.exports = d
        }, {
            "./lib/re": 54
        }],
        54: [function (e, r, t) {
        ...
        59: [function (e, r, t) {
            ...
            n.prototype.parse = function (e, r) {
                ...
                if (g && (o = (g = g[0]).toLowerCase(), this.protocol = g, m = m.substr(g.length)), (r || g || m.match(/^\/\/[^@\/]+@[^@\/]+/)) && (!(c = "//" === m.substr(0, 2)) || g && f[g] || (m = m.substr(2), this.slashes = !0)), !f[g] && (c || g && !d[g])) {
                    ...
                    for (-1 !== (b = -1 === v ? m.lastIndexOf("@") : m.lastIndexOf("@", v)) && (k = m.slice(0, b), m = m.slice(b + 1), this.auth = k), v = -1, t = 0; t < l.length; t++) - 1 !== (a = m.indexOf(l[t])) && (-1 === v || a < v) && (v = a); - 1 === v && (v = m.length), ":" === m[v - 1] && v--;
                    var y = m.slice(0, v);
                ...
                ! function (n) {
                    ...
                    function T(e) {
                        ...
                        for (n = s = D.length, s && D.push(g); n < b;) {
                            ...
                            for (a - r > x((l - t) / (v = n + 1)) && w("overflow"), t += (a - r) * v, r = a, i = 0; i < b; ++i)
                                if ((k = e[i]) < r && ++t > l && w("overflow"), k == r) {
                    ...
                    if (a = {
                        ...
                        if (r.exports == s) o.exports = a;
                            ...
                            for (c in a) a.hasOwnProperty(c) && (s[c] = a[c]);
                    else n.punycode = a
                }(this)
